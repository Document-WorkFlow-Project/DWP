...
interface StagesInterface {
     ...
     */
    fun stageSignatures(stageId: String,userAuth: UserAuth): List<Signature>
     ...
     */
    fun stageDetails(stageId: String,userAuth: UserAuth): Stage
     ...
     */
    fun stageComments(stageId: String,userAuth: UserAuth): List<Comment>
