...
DO $$
BEGIN
    EXECUTE format('INSERT INTO utilizador VALUES (''%s'', ''Administrador principal'', ''bd39bea0-ba49-4fda-8660-b8870b3ae187'', ''c93ccd78b2076528346216b3b2f701e6'')', current_setting('app.admin_email'));
    EXECUTE format('INSERT INTO utilizador_papel VALUES (''admin'', ''%s'')', current_setting('app.admin_email'));
END $$;
